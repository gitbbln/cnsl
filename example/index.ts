import { Cnsl } from "../src/index";
import { TNumber } from "../src/index.d";
...
*/
const cnsl = new Cnsl()
let arr1: string[] = 'a,b,c'.split(",");
let obj: TNumber = cnsl.ao(arr1)
//console.log(cnsl);

//console.log(`'${obj.a}'`);
let cursor: any = cnsl.cursor;
let log: any = cnsl.log
let loc: any = cnsl.loc;
